    ...
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 leadinf-7 font-montserrat text-base text-white-400 sm:max-w-sm">
            ...
            <div key={section}>
              ...
              <ul>
                {section.links.map((link) =>(
                  <li className="leading-normal font-montserrat text-base text-white-400 hover:text-slate-gray cursor-pointer" key={link.name}>
                    <a>{link.name}</a>
                  </li>
                ))}
              </ul>
